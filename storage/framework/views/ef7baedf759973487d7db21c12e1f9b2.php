...
<?php $__env->startSection('title', 'HC COM-SYS Říčany'); ?>
...
<nav id="navbar">
  ...
  <div class="nav-right">
    ...
    <?php if(auth()->guard()->check()): ?>
      <a href="<?php echo e(route('admin.articles.index')); ?>" class="nav-admin-btn">
        <span>Admin</span>
      </a>
    <?php else: ?>
      <a href="<?php echo e(route('login')); ?>" class="nav-admin-btn">
...
<section class="hero">
  ...
  <div class="container hero-content">
    ...
    <div style="display:flex;align-items:center;gap:40px;flex-wrap:wrap;" class="fade-in fade-in-2">
      <img src="<?php echo e(asset('assets/img/HC_Ricany_logo.png')); ?>" alt="HC COM-SYS Říčany logo"
  ...
  <div class="container">
    ...
    <div class="news-grid" id="news-grid">
      <?php $__empty_1 = true; $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="news-card <?php echo e($article->is_featured ? 'featured' : ''); ?>" data-id="<?php echo e($article->id); ?>">
          <div class="news-date"
               data-cs="<?php echo e($article->published_at ? $article->published_at->translatedFormat('j. F Y') : ''); ?> &middot; <?php echo e($article->category_cs); ?>"
               data-en="<?php echo e($article->published_at ? $article->published_at->format('F j, Y') : ''); ?> &middot; <?php echo e($article->category_en); ?>">
            <?php echo e($article->published_at ? $article->published_at->translatedFormat('j. F Y') : ''); ?> &middot; <?php echo e($article->category_cs); ?>

          </div>
          <h3 data-cs="<?php echo e($article->title_cs); ?>" data-en="<?php echo e($article->title_en ?? $article->title_cs); ?>">
            <?php echo e($article->title_cs); ?>

          </h3>
          <p data-cs="<?php echo e($article->excerpt_cs); ?>" data-en="<?php echo e($article->excerpt_en ?? $article->excerpt_cs); ?>">
            <?php echo e($article->excerpt_cs); ?>
...
<?php echo $__env->make('layouts.hc', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MSI\Documents\GitRepos\_personal_\hc_ricany\resources\views/home.blade.php ENDPATH**/ ?>