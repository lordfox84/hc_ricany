@extends('layouts.hc')
@section('title', 'Upravit termín bruslení | Admin HC Říčany')
  ...
  <div class="admin-layout">
    ...
    <main class="admin-content">
      <div class="admin-panel-section active">
        <div class="admin-page-title">Upravit termín</div>
        <div class="admin-page-subtitle"><a href="{{ route('admin.skating.index') }}" style="color:var(--teal);">← Zpět na seznam</a></div>

        <form method="POST" action="{{ route('admin.skating.update', $skating) }}" style="margin-top:28px;">
          @csrf @method('PUT')
          @include('admin.skating._form')
          <div style="margin-top:24px;display:flex;gap:12px;">
            <button type="submit" class="admin-btn">Uložit změny</button>
