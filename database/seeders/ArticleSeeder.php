...
class ArticleSeeder extends Seeder
{
    ...
    {
        $admin  = User::first();
        $zapas  = Category::where('slug', 'zapas')->first();
        $mladez = Category::where('slug', 'mladez')->first();
        $klub   = Category::where('slug', 'klub')->first();
        $trenink = Category::where('slug', 'trenink')->first();
        ...
        $articles = [
            [
                ...
                'category_cs' => 'Zápas', 'category_en' => 'Match',
                'category_id' => $zapas?->id,
            ...
            [
                ...
                'category_cs' => 'Mládež', 'category_en' => 'Youth',
                'category_id' => $mladez?->id,
            ...
            [
                ...
                'category_cs' => 'Klub', 'category_en' => 'Club',
                'category_id' => $klub?->id,
                'is_featured' => false, 'is_published' => true,
            ...
            [
                ...
                'category_cs' => 'Trénink', 'category_en' => 'Training',
                'category_id' => $trenink?->id,
                'is_featured' => false, 'is_published' => true,
